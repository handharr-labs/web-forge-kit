...
/**
 * Overlay dialog shell: a scrim with a centered panel. Closes on scrim click and
 * Escape. Bronze keeps it static — no entrance animation.
 */
function Modal({
  open = true,
  title,
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "flex max-h-[90vh] w-full flex-col overflow-y-auto rounded-[var(--radius)] bg-[var(--background)] p-5 shadow-lg ring-1 ring-[var(--border)]",
          SIZES[size],
          className
        )}
      >
