 ...
 * it does not upload or persist the file. Silver adds an upload glyph and a
...
function FileDropzone({
  ...
  return (
    <div data-slot="file-dropzone" className={cn("flex flex-col gap-3", className)}>
      <label className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-[var(--radius)] border border-dashed border-[var(--border)] px-4 py-12 text-center transition-colors hover:bg-[var(--muted)]">
        <Upload className="size-6 text-[var(--muted-foreground)]" aria-hidden="true" />
